...
def get_weight_saver(arch: str):
    from verl.models.llama.megatron.checkpoint_utils.llama_saver import (
        merge_megatron_ckpt_llama,
    )
    from verl.models.qwen2.megatron.checkpoint_utils.qwen2_saver import (
        merge_megatron_ckpt_qwen2,
    )
